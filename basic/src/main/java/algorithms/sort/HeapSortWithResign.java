...
public class HeapSortWithResign {
        ...
        private void heapify(int index, int heapSize) {
            ...
            while (leftIndex < heapSize) {
                ...
                if ((leftIndex + 1) < heapSize) {
                    largestIndex = comparator.compare(heap.get(leftIndex), heap.get(leftIndex + 1)) > 0 ? leftIndex : (leftIndex + 1);
                } else {
                    largestIndex = leftIndex;
                }
                largestIndex = comparator.compare(heap.get(largestIndex), heap.get(index)) > 0 ? largestIndex : 0;
